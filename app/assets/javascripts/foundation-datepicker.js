...
! function($) {
    ...
    var DPGlobal = {
        ...
        headTemplate: '<thead>' +
            '<tr>' +
            '<th class="prev"><i class="Icon--arrowLeft"/></th>' +
            '<th colspan="5" class="date-switch"></th>' +
            '<th class="next"><i class="Icon--arrowRight"/></th>' +
            '</tr>' +
            '</thead>',
    ...
    DPGlobal.template = '<div class="datepicker">' +
        ...
        '</table>' +
        '</div>' +
        '<a class="button datepicker-close tiny alert right" style="width:auto;"><i class="Icon--closeAlt"></i></a>' +
        '</div>';
